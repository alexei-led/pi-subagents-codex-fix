import { ExecutionOwnershipSchema, OwnedWorkflowSchema } from "../runs/shared/owned-workflow.ts";
/**
...
const SubagentParamProperties = {
	...
	executionOwnership: Type.Optional(ExecutionOwnershipSchema),
	ownedWorkflow: Type.Optional(OwnedWorkflowSchema),
