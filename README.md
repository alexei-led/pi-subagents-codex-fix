...
| [Lifetime and durable operations](docs/autonomous-runtime-contract.md) | Explicit execution lifetimes, correlated RPC launches, cancellation fences, and process containment limitations. |
